...
const HacEkonomik = () => {
  // const dateLength = 2;
  const dayCounts = ['30 - 35 Gün'];
  const nightsDays = ['4 Gece Medine'];
    ...
    <StyledCardCont className="text-center mt-5" style={{ backgroundColor: '#dfd9d9' }}>
      <StyledSection className="d-flex justify-content-around pb-0 p-3" style={{ backgroundColor: '#ce9136' }}>
        <StyledSectionMini style={{ fontSize: '20px' }} className="text-white">
          EKONOMİK HAC PROGRAMI
        </StyledSectionMini>
        <StyledSectionMini style={{ fontSize: '20px' }} className="text-white text-uppercase">
          SERVİSLİ OTELLER
        </StyledSectionMini>
        {true && <StyledSectionMini className="text-white text-uppercase">4 GÜN MEDİNE</StyledSectionMini>}
        {false && (
              ...
              <StyledRow className="row text-center">
                ...
                <StyledCol className="col-xl-3 col-xxl-3">
                  ...
                  <StyledRoomsNights style={{ marginBottom: '7.4px' }}>
                    <div>
                      <MobileNone>{dayCounts[0]}:</MobileNone>
                      <span className="fw-bold"> {false ? '----' : `28.500 SAR ($7.600)`}</span>
                    </div>
                    {nightsDays[0] && <MobileNone style={{ fontSize: '.8em' }}>({nightsDays[0]})</MobileNone>}
                  </StyledRoomsNights>
                  {/* <StyledHR style={{ marginBottom: '-4px' }} />
                ...
                <StyledCol className="col-xl-3 col-xxl-3">
                  ...
                  <StyledRoomsNights style={{ marginBottom: '7.4px' }}>
                    <div>
                      <MobileNone>{dayCounts[0]}:</MobileNone>
                      <span className="fw-bold"> {false ? '----' : `26.500 SAR ($7.065)`}</span>
                    </div>
                    {nightsDays[0] && <MobileNone style={{ fontSize: '.8em' }}>({nightsDays[0]})</MobileNone>}
                  </StyledRoomsNights>
                ...
                <StyledCol className={`col-xl-3 col-xxl-3 ${true ? 'mobile-none' : ''}`}>
                  ...
                  <StyledRoomsNights style={{ marginBottom: '7.4px' }}>
                    <div>
                      <MobileNone>{dayCounts[0]}:</MobileNone>
                      <span className="fw-bold"> {false === '-' ? '----' : '24.500 SAR ($6.534)'}</span>
                    </div>
                    {nightsDays[0] && <MobileNone style={{ fontSize: '.8em' }}>({nightsDays[0]})</MobileNone>}
                  </StyledRoomsNights>
              ...
              <div>
                ...
                <DatesRow className="row">
                  <StyledDates type="less" className="text-center" style={{ fontSize: '.9em' }}>
                    <li>
                      <span className="fw-bold">9 MAYIS - 12 HAZİRAN 2024</span>
                    </li>
                  </StyledDates>
                </DatesRow>
                
                <StyledH6 className="mb-3 text-uppercase fw-bold">DÖNÜŞ TARİHLERİ</StyledH6>
                <DatesRow className="row">
                  <StyledDates type="less" className="text-center" style={{ fontSize: '.9em' }}>
                    <li>
                      <span className="fw-bold">22 HAZIRAN - 17 TEMMUZ 2024</span>
                    </li>
                  </StyledDates>
                </DatesRow>
              </div>
      ...
      <StyledSectionBottom className="d-flex text-white justify-content-center pb-0 p-3" style={{ backgroundColor: '#0E2954' }}>
        <div className="row">
          <StyledSectionMini type="bottom" className="text-white col-xl-6 col-md-12">
            Mekke Otel: Servisli Oteller (2 - 7 KM)
          </StyledSectionMini>
          <StyledSectionMini type="bottom" className="text-white col-xl-6 col-md-12">
            Medine Otel: Merkeziye Bölgesi (400 - 500M)
          </StyledSectionMini>
          <StyledSectionMini type="bottom" className="text-white col-xl-6 col-md-12">
            Sabah ve Akşam Yemekleri TABLDOT
          </StyledSectionMini>
          <StyledSectionMini type="bottom" className="text-white col-xl-6 col-md-12">
            Öğle Yemekleri KUMANYA
          </StyledSectionMini>
        </div>
      </StyledSectionBottom>
    </StyledCardCont>
